...
float a=0.42;//square turn
float b=0.84;//square front
float c=1.05;//rectangle side
float d=0.89;//triangle hypo
float e=0.63;//triangle side
int servopin=10;
Servo myservo;
int sws1;
int sws2;
...
void triangle(){
   ...
   delay(500);
    myStepper.setSpeed(15);
    myStepper2.setSpeed(15);
    for (int i = 0; i < stepsPerRevolution*e; i++) {
        myStepper.step(1);
        myStepper2.step(-1);
    }
    delay(1000);
